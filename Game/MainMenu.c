...
void gamelog(int tc, char ct); //menampilkan turncounter dan current team
...
void play(Stack* S) 
{
    ...
    int i; 
    int tc;  //tc adalah turn counter,
    char ct; //ct adalah current team
    Queue turn;
    char str[20];
    boolean donemove;
    ...
    while (tc <= 100) {
        ...
        if (tc >= 3) {
            ...
            if (ct == 'W') {
                ...
                if (isCheckmate(B, white.arr[i].p.xpos, white.arr[i].p.ypos, ct, white)) {
                    break;
                }
            } else {
                while (black.arr[i].p.type != 'k') {
                ...
                if (isCheckmate(B, black.arr[i].p.xpos, black.arr[i].p.ypos, ct, black)) {
                    break;
                }
            }
        }
        ...
        while (donemove == false) {
            ...
            if (ct == 'W') {
                if (strcmp(str, "MOVE") == 0) {
                    ...
                    move(S, ct, &white, &black, &B);
                    donemove = true;
                    tc++;

                } else if (strcmp(str, "SPECIAL_MOVE") == 0) {

                    special_move(&white, &black, &B, S, ct, &donemove);
                    if (donemove == true) {
                        tc++;
                    }
                    ...
                    donemove = true;
                    tc -= 2;
                    ct = get_turn(&turn); /*Agar saat masuk ke loop, turn tetap tim W*/
                }
            } else {
                if (strcmp(str, "MOVE") == 0) {

                    move(S, ct, &black, &white, &B);
                    donemove = true;
                    tc++;
                    ...
                    donemove = true;
                    tc -= 2;
                    ct = get_turn(&turn); /*Agar saat masuk ke loop, turn tetap tim B*/
                }
            }
        }
    }
